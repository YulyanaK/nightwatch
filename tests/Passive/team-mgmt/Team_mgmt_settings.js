...
module.exports = {
  ...
  'Change org settings': function(browser) {
      browser
        ...
        .setValue('textarea.content-field-textarea', 'Nuna')
        .clearValue('textarea.content-field-textarea')
        .pause(model.pause + 1000) 
        .setValue('textarea.content-field-textarea', 'Nun avut')
        .pause(model.pause + 1000) 
        .clearValue('textarea.content-field-textarea')
        .pause(model.pause + 1000) 
        ...
        .setValue('input[type="file"]', require('path').resolve('/tmp/CSV_example.csv'))
        
        .pause(model.pause + 18000)
        .end()
    },
}