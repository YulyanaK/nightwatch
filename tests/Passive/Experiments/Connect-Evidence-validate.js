...
module.exports = {
    ...
    'Run experiments and validate connections before analyzed': function(browser) {
    	  browser
    		...
    		.pause(model.pause + 500)
    		.click("(//div[@class='criteria-selection-icon-checkmark'])[7]")
    		.pause(model.pause + 500)
      	...
      	.click("(//div[@class='evidence-icon hover Disconfirming'])[12]")
   			.pause(model.pause + 500)
   			.click("(//div[@class='evidence-icon hover Neutral'])[8]")
   			.pause(model.pause + 500)
   			.click("(//div[@class='evidence-icon hover Leaning Confirming'])[9]")
   			.pause(model.pause + 500)	 
   			.click("(//div[@class='evidence-icon hover Confirming'])[10]")
   			.pause(model.pause + 500)	 
   			.click("(//div[@class='evidence-icon hover Leaning Confirming'])[11]")
   			.pause(model.pause + 500)
   			.click("(//div[@class='evidence-icon hover Neutral'])[12]")
   			.pause(model.pause + 500)	 
   			.click("(//div[@class='evidence-icon hover Leaning Disconfirming'])[13]")
   			.pause(model.pause + 500)	 
   			.click("(//div[@class='evidence-icon hover Disconfirming'])[14]")	
   			.pause(model.pause + 500) 
