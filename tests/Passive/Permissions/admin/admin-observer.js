...
module.exports = {
  ...
  'view images': function(browser) {
      browser
        ...
        .waitForElementPresent("(//div[@data-test='KeyPartners0'])", 6000, 'selects a card to see images')
  ...
  'View activity feed can favorite cards': function(browser) {
      browser
        .waitForElementPresent("(//div[@class='basic-dropdown-selected-text center-nav-page-routes '])", 6000,  'opens for feed')
