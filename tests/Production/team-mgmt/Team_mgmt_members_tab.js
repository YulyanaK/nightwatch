...
module.exports = {
  ...
  'Verify the organizations for Project dashboard' : function(browser) {
      browser
        .useXpath()
        .waitForElementPresent("(//div[@class='org-dashboard-card-container'])[1]", 4000).pause(model.pause + 500)
        .click("(//div[@class='org-dashboard-card-container'])[1]")
  ...
  'everyone tab team management': function(browser) {
      browser
        ...
        .verify.elementPresent('li.teamMgmtTab.members', 'verifies for member').pause(model.pause + 500)
