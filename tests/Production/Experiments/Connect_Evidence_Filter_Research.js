...
module.exports = {
  ...
  'Create an research plan phase': function(browser) {
     browser
        ...
        .setValue("(//textarea[@class='content-field-textarea'])[3]", ['New Evidence testing', browser.Keys.ENTER])
                  
        .verify.elementPresent("(//div[@class='card-nav-option'])[2]", 'open help center').pause(model.pause + 800)
        .click("(//div[@class='card-nav-option'])[2]")

.pause()
        .verify.elementPresent('div.wistia_click_to_play', 'plays video').pause(model.pause + 800)
        .click('div.wistia_click_to_play')
  ...
  'Run an experiment connect an evidence': function(browser) {
     browser
        ...
        .waitForElementPresent('div.choose-card-type-selection-close-icon', 3500)
